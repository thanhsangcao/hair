<div class="dropdown" id="{{ $booking->id }}">
    @if( $booking->status == __('booking.new') )
        <button class="btn btn-info dropdown-toggle btn-status" type="button" data-toggle="dropdown">New <span class="caret"></span></button>
    ...
    @elseif( $booking->status == __('booking.confirm') )
        <button class="btn btn-primary dropdown-toggle btn-status" type="button" data-toggle="dropdown">Confirmed <span class="caret"></span></button>
        <ul class="dropdown-menu">
    ...
    @elseif( $booking->status == __('booking.complete'))
        <button class="btn btn-success dropdown-toggle btn-status" type="button" data-toggle="dropdown">Completed </button>
        
    @elseif( $booking->status == __('booking.cancel'))
        <button class="btn dropdown-toggle btn-status" type="button" data-toggle="dropdown">Canceled <span class="caret"></span></button>
        <ul class="dropdown-menu">
