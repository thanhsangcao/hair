        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-lg-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">{{ __('Create a new RenderBooking') }}</div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group" >
                                        {!! Form::label('', __('Day')) !!}
                                        {!! Form::text('day', '', ['class' => 'form-control', 'required' => 'required']) !!}
                                    </div>
                                    <div class="form-group" >
                                        {!! Form::label('', __('Time_start')) !!}
                                        {!! Form::text('time_start', '', ['class' => 'form-control', 'required' => 'required']) !!}
                                    </div>
                                    <div class="form-group" >
                                        {!! Form::label('', __('Status')) !!}
                                        {!! Form::text('status', '', ['class' => 'form-control', 'required' => 'required']) !!}
                                    </div>
                                    <div class="form-group" >
