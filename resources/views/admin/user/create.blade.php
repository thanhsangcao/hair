        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">{{ __('Create a new User') }}</div>
                        ...
                        {!! Form::open(['method' => 'post', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <div class="form-group" >
                                        {!! Form::label('', __('Salon')) !!}
                                        {!! Form::select('salon_id', $selectSalon, null,['class' => 'form-control']) !!}
                                    </div>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        {!! Form::select('permission', $selectRole, null, ['class' => 'form-control']) !!}
                                    </div>
